...
and it should show that it's online. if it shows offline, go to your application.yml and make sure metrics is set to on
![freshpingisbetterthanuptimerobot](https://darrennathanael.com/cdn/873E3AB4-8862-49A2-B5F6-5A0B97E3BCF1.jpeg)

- - -
only needed if the run button doesn't work.
```bash
chmod +x start.sh
```
```bash
...
The [lavalink](https://github.com/melike2d/lavalink) is based on https://github.com/melike2d/lavalink and the download URL is pointed to https://cdn.darrennathanael.com/jars/Lavalink.jar so every time there's a new update it will auto grab it from that URL